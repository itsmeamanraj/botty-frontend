...
export default function Footer() {
  return (
    <footer className="border-t border-slate-200 bg-slate-50 py-12 relative z-10">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-12 gap-10">
        ...
        <div className="md:col-span-5 flex flex-col gap-4">
          ...
          <p className="text-xs text-slate-500 max-w-sm leading-relaxed">
            The next-generation AI-powered business communication and WhatsApp automation agent. Empowering customer support and lead workflows globally.
          </p>
          <div className="flex items-center gap-3 mt-2">
            <a href="#" className="p-2 rounded-lg bg-slate-200/50 text-slate-500 hover:text-slate-900 hover:bg-slate-200 transition-all">
        ...
        <div className="md:col-span-7 grid grid-cols-3 gap-6">
          ...
          <div className="flex flex-col gap-3">
            <h5 className="text-xs font-bold text-slate-900 uppercase tracking-wider">Product</h5>
            <ul className="flex flex-col gap-2 text-xs text-slate-500">
              ...
              <li><a href="#integrations" className="hover:text-slate-900 transition-colors">Integrations</a></li>
            </ul>
          </div>
          ...
          {/* Legal Links */}
          <div className="flex flex-col gap-3">
            <h5 className="text-xs font-bold text-slate-900 uppercase tracking-wider">Legal</h5>
            <ul className="flex flex-col gap-2 text-xs text-slate-500">
              <li><a href="#privacy" className="hover:text-slate-900 transition-colors">Privacy Policy</a></li>
              <li><a href="#terms" className="hover:text-slate-900 transition-colors">Terms of Use</a></li>
      ...
      <div className="max-w-7xl mx-auto px-6 border-t border-slate-200 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
        <span className="text-[10px] text-slate-400 font-medium">
          &copy; {new Date().getFullYear()} Botty AI Inc. All rights reserved.
        </span>
        <span className="text-[10px] text-slate-400 font-medium">
          Built for modern enterprise security and HIPAA compliance.
        </span>
      </div>
    </footer>
  );
